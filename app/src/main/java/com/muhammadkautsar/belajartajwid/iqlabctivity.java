...
public class iqlabctivity extends AppCompatActivity {
ImageButton pindah;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_iqlabctivity);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exit.start();
                Intent intent = new Intent(iqlabctivity.this, hukumnunactivity.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                home.start();
                Intent intent = new Intent(iqlabctivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
