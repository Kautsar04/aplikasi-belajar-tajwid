...
public class ikhfahaqiqiactivity extends AppCompatActivity {
ImageButton pindah;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ikhfahaqiqiactivity);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exit.start();
                Intent intent = new Intent(ikhfahaqiqiactivity.this, hukumnunactivity.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                home.start();
                Intent intent = new Intent(ikhfahaqiqiactivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
