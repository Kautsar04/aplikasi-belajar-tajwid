...
public class ikhfasyafawiactivity extends AppCompatActivity {
ImageButton pindah;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ikhfasyafawiactivity);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exit.start();
                Intent intent = new Intent(ikhfasyafawiactivity.this, hukummimactivity.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                home.start();
                Intent intent = new Intent(ikhfasyafawiactivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
