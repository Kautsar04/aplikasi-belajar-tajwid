...
public class idghammimiactivity extends AppCompatActivity {
ImageButton pindah;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_idghammimiactivity);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exit.start();
                Intent intent = new Intent(idghammimiactivity.this, hukummimactivity.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                home.start();
                Intent intent = new Intent(idghammimiactivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
