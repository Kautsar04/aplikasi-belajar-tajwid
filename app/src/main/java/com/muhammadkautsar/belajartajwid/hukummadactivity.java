...
public class hukummadactivity extends AppCompatActivity {
    ImageButton pindah;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_hukummadactivity);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                exit.start();
                Intent intent = new Intent(hukummadactivity.this, hukumnunactivity.class);
        ...
        pindah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                home.start();
                Intent intent = new Intent(hukummadactivity.this, MainActivity.class);
                startActivity(intent);
            }
        });
    }
